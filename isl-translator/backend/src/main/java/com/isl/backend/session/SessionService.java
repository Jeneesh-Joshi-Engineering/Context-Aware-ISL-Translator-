...
public class SessionService {
    ...
    public void joined(String id, String role) { getOrCreate(id).setConnected(role, true); }
    ...
    public void append(String id, TranslatedMessagePayload message) { getOrCreate(id).addMessage(message); }
